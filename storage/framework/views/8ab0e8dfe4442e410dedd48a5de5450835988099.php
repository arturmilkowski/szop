...
<?php echo $__env->renderComponent(); ?>
    <div class="row">
        <div class="col">
                    <form class="mt-3" method="POST" action="<?php echo e(route('login')); ?>">
                        <?php echo csrf_field(); ?>

                        <div class="form-group row">
                            <label for="email" class="col-md-2 col-form-label"><?php echo e(__('E-Mail Address')); ?></label>
                            <div class="col-md-10">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group row">
                            <label for="password" class="col-md-2 col-form-label"><?php echo e(__('Password')); ?></label>
                            <div class="col-md-10">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/szop/resources/views/auth/login.blade.php ENDPATH**/ ?>