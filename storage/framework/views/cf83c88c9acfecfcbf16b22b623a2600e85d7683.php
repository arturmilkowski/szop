<?php $__env->startSection('title', 'regulamin sklepu'); ?>
<?php $__env->startSection('description', 'regulamin sklepu'); ?>
<?php $__env->startSection('keywords', 'woda kolońska, woda toaletowa, perfumy, zapachy, perfumeria, perfumeria niszowa'); ?>
...
<?php $__env->startSection('content'); ?>
            ...
            <div class="row mt-3">
                ...
                <div class="col-sm-8">
                    <?php echo $__env->make('frontend.includes.rodo', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
                </div>
            </div>
<?php $__env->stopSection(); ?>

<?php echo $__env->make('frontend.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/szop/resources/views/frontend/page/term_condition.blade.php ENDPATH**/ ?>